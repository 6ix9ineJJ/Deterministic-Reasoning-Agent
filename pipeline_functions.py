...
def create_retrievers():
    ...
    chunks_vector_store = FAISS.load_local("chunks_store", embeddings, allow_dangerous_deserialization=True)
    chapter_summaries_vector_store = FAISS.load_local("chapter_summaries_store", embeddings, allow_dangerous_deserialization=True)
    book_quotes_vectorstore = FAISS.load_local("book_quotes_store", embeddings, allow_dangerous_deserialization=True)
